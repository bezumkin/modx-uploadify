...
$package = 'uploadify'; // Class name for generation
$suffix = 'uploadify_'; // Suffix of tables.
...
//$manager->removeObjectContainer('ufUserFile');

//$manager->createObjectContainer('ufUserFile');
